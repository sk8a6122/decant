...
const crisp=wine('Sauvignon Blanc',['White'],['sauvignon blanc','sancerre','pouilly fume'],'Crisp acidity and herbal notes complement tangy, green, and fresh flavors.');
const chardonnay=wine('Chardonnay',['White'],['chardonnay','chablis','white burgundy'],'Freshness with a little texture complements creamy or buttery flavors; choose lighter oak for delicate food.');
const pinot=wine('Pinot Noir',['Red'],['pinot noir','red burgundy'],'Light tannins and red fruit work with savoury flavors without dominating them.');
...
const chips=extra('Classic salty snacks',['chip','crisp','popcorn','pretzel','fries','french fry','potato chip','french fries'],'Salt and crunch make an easy excuse to open something fresh. Add a chip flavor to find a more specific match.',[bubbles,rose,chardonnay]);
...
export function pairingFor(food:string):PairingProfile|null{
 ...
 // Snack flavor takes precedence over isolated ingredients such as cheese or onion.
