...
const CACHE='decant-shell-72106573e0f7';
const FILES=["./index.html","./manifest.webmanifest","./catalog-config.js","./supabase-config.js","./assets/app-f63bd19b8cd3.js","./assets/app-14d876790a78.css","./assets/wine-editorial-800.webp","./assets/wine-editorial-1600.webp","./assets/icon-192.png","./assets/icon-512.png","./assets/icon-maskable-512.png"];
