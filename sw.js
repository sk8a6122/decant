...
const CACHE='decant-shell-8982c4d93e85';
const FILES=["./index.html","./manifest.webmanifest","./catalog-config.js","./supabase-config.js","./assets/app-bbbaccf85738.js","./assets/app-eacd5cf7df60.css","./assets/wine-editorial-800.webp","./assets/wine-editorial-1600.webp","./assets/icon-192.png","./assets/icon-512.png","./assets/icon-maskable-512.png"];
