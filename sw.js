...
const CACHE='decant-shell-grapes-20260914';
const FILES=["./index.html","./manifest.webmanifest","./catalog-config.js","./supabase-config.js","./assets/app-grapes-20260914.js","./assets/app-6c2053541384.css","./assets/wine-editorial-800.webp","./assets/wine-editorial-1600.webp","./assets/icon-192.png","./assets/icon-512.png","./assets/icon-maskable-512.png"];
